...
public class CRSAdminAPI {
	...
	public ResponseEntity<String> assignCourseToProfessor(@PathParam("professorId") int professorId, @PathParam("courseCode") String courseCode) {
			try {
				...
				return new ResponseEntity<String>("courseCode: " + courseCode + " assigned to professor: " + professorId, HttpStatus.OK);
	...
	public ResponseEntity<String> deleteCourse(@RequestParam("courseCode") String courseCode){
		try {
			...
			return new ResponseEntity<String>("Course with courseCode: " + courseCode + " deleted from catalog", HttpStatus.OK);
		} catch (Exception e) {
			return new ResponseEntity<String>("Error: "+e.getMessage(), HttpStatus.BAD_REQUEST);
		}	
	}
	...
	public ResponseEntity<String> addCourse(@RequestBody Course course) {
		try {
			...
			return new ResponseEntity<String>("Course with courseCode: " + course.getCourseCode() + " added to catalog",HttpStatus.OK);
