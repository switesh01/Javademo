...
public class SQLQueriesConstants {
	...
	public static final String VIEW_PENDING_ADMISSION_QUERY = "select user_id, user_name, password, role, student_id from student inner join user on student.student_id=user.user_id where is_approved = 0";
