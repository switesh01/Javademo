...
public class SQLQueriesConstants {
	...
	public static final String ADD_COURSE_QUERY = "insert into Course(course_code, course_name, catalog_id) values (?, ?, ?)";
	public static final String VIEW_PENDING_ADMISSION_QUERY = "select user_id, user_name, password, role, student_id from student natural join user where is_approved = 0";
	...
	public static final String ADD_PROFESSOR_QUERY = "insert into Professor(user_id, department, designation) values (?, ?, ?)";
	...
	public static final String VIEW_PROFESSOR_QUERY = "select user_id, user_name,  department, designation from Professor natural join User";
